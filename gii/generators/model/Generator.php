...
namespace coreb2c\smartadmin\gii\generators\model;
    ...
    public function generate() {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                ...
                'hasAuthModule' => (\Yii::$app->hasModule('auth') and ( $module = \Yii::$app->getModule('auth')) instanceof \coreb2c\auth\Module) ? true : false,
            ];
            $files[] = new CodeFile(
